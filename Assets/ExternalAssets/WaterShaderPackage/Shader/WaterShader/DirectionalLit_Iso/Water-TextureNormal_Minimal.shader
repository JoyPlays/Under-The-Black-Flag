...
Shader "Water/TextureNormalLit_Iso/Minimal" 
{
	/* 
	...
	SubShader 
	{
		...
		////// Shader functions
			...
			{				
				...
				// Final composition
				float4 final = float4( saturate(diffuseLight * tex2D(_MainTex, fragIn.uv_Tex.xy) + specularLight), _Transparency) ;
